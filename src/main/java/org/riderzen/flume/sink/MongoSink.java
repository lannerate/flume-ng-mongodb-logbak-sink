...
import ch.qos.logback.decoder.StaticLoggingEvent;
import com.mongodb.*;
...
public class MongoSink extends AbstractSink implements Configurable {
    ...
    public static final String LOG_CLASSNAME = "className";
    public static final String LOG_MESSAGE = "message";
    public static final String LOG_PID = "pid";
    public static final String LOG_IP = "ip" ;
    public static final String UNKNOW_HOST = "unknow host";

    public static final String PATTERN="pattern";
    public static final String DEFAULT_PATTERN="%d{yyyy/MM/dd HH:mm:ss} %-5p  LINE[%L] %c - %msg%n";
    ...
    public void configure(Context context) {
        ...
        pattern = context.getString(PATTERN,DEFAULT_PATTERN);
        logger.info("MongoSink {} context { host:{}, port:{}, authentication_enabled:{}, username:{}, password:{}, model:{}, dbName:{}, collectionName:{}, batch: {}, autoWrap: {}, wrapField: {}, timestampField: {},pattern: {} }",
                new Object[]{getName(), host, port, authentication_enabled, username, password, model, dbName, collectionName, batchSize, autoWrap, wrapField, timestampField,pattern});
    }
    ...
    private synchronized Status  parseEvents() throws EventDeliveryException {
        Status status = Status.READY;
...
//                    final String PATT = "%d{yyyy/MM/dd HH:mm:ss} %-5p LINE[%L] %c - %msg%n";
                    ...
                    if(null!=loggingEvent&&null!=loggingEvent.getLevel()){
                        ...
                        eventJson.put(LOG_PID,this.getPid());
                        eventJson.put(LOG_IP,this.getIp());
                    }
                }
            } catch (Exception e) {
    ...
    public static String getLogPattern(){
        ...
        try {
            ...
            throw new IllegalStateException("Could not find properties file:log4j.properties " );
        }
        return properties.getProperty("log4j.appender.out.layout.ConversionPattern");
    }
}
